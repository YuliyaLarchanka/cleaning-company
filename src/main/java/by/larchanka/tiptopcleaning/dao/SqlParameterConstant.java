...
public class SqlParameterConstant {
    ...
    public static final String SQL_ACCOUNT_HOUSE = "house";
    public static final String SQL_ACCOUNT_APARTMENT = "apartment";
    public static final String SQL_ACCOUNT_ENTRANCE = "entrance";
    public static final String SQL_ACCOUNT_FLOOR = "floor";
    public static final String SQL_ACCOUNT_INTERCOM_CODE = "intercom_code";

    public static final String SQL_CATALOG_ITEM_ID = "catalog_item_id";
    public static final String SQL_CATALOG_ITEM_NAME = "name";
